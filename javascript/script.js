...
const kinder2 = document.getElementById('kinder2');
...
function validateForm(){
  if(!checkRequired([username, email, password, date2, erwachsen2, password_control2, telefonnummer2, name2, vorname2, password2, kinder2])){
  let list = []
    ...
    list.push(checkLength(erwachsen2, 0, 1));
    list.push(checkLength(kinder, 0, 1));
